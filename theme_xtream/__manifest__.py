...
#############################################################################
{
    ...
    'data': [
        ...
        'views/snippets/product_snippet1.xml',
        'views/snippets/multiple_slider_product.xml',
        'views/snippets/text_block.xml',
        'views/snippets/nos_references.xml',
        'views/snippets/info_2.xml',
